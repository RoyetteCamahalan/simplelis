...
Public Class FecalysisRPT1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.FecalysisRPT1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFecalysisRPT1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FecalysisRPT1 = New FecalysisRPT1()
        rpt.Site = Me.Site
        Return rpt
    End Function
