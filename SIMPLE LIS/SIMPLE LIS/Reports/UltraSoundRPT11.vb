...
Public Class UltraSoundRPT1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.UltraSoundRPT1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUltraSoundRPT1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UltraSoundRPT1 = New UltraSoundRPT1()
        rpt.Site = Me.Site
        Return rpt
    End Function
