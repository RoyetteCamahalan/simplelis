...
Public Class BloodChemistryRPT1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.BloodChemistryRPT1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBloodChemistryRPT1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BloodChemistryRPT1 = New BloodChemistryRPT1()
        rpt.Site = Me.Site
        Return rpt
    End Function
