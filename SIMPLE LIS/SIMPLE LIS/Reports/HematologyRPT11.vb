...
Public Class HematologyRPT1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.HematologyRPT1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHematologyRPT1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HematologyRPT1 = New HematologyRPT1()
        rpt.Site = Me.Site
        Return rpt
    End Function
