...
Public Class crptBloodChemistry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.crptBloodChemistry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptBloodChemistry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptBloodChemistry = New crptBloodChemistry()
        rpt.Site = Me.Site
        Return rpt
    End Function
