...
Public Class CrossmatchingRPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.CrossmatchingRPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrossmatchingRPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrossmatchingRPT = New CrossmatchingRPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
