...
Public Class RadiologyRPT1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.RadiologyRPT1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRadiologyRPT1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RadiologyRPT1 = New RadiologyRPT1()
        rpt.Site = Me.Site
        Return rpt
    End Function
