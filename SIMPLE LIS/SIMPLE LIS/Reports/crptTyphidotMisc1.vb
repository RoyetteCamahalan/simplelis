...
Public Class crptTyphidotMisc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.crptTyphidotMisc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptTyphidotMisc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptTyphidotMisc = New crptTyphidotMisc()
        rpt.Site = Me.Site
        Return rpt
    End Function
