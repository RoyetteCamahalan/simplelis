...
Public Class ECGDetailsRPT2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.ECGDetailsRPT2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedECGDetailsRPT2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ECGDetailsRPT2 = New ECGDetailsRPT2()
        rpt.Site = Me.Site
        Return rpt
    End Function
