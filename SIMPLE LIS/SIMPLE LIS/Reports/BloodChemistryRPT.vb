...
Public Class BloodChemistryRPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.BloodChemistryRPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBloodChemistryRPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BloodChemistryRPT = New BloodChemistryRPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
