...
Public Class nbsDetailsRPT2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPLE_LIS.nbsDetailsRPT2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachednbsDetailsRPT2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nbsDetailsRPT2 = New nbsDetailsRPT2()
        rpt.Site = Me.Site
        Return rpt
    End Function
