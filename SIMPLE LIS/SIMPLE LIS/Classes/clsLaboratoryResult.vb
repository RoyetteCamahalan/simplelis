...
#Region "Methods"
    ...
    Public Function Save(ByVal isNew As Boolean) As DataTable
        ...
        Dim strPar() As String = {"@operation", "@soperation", "@Oldlaboratoryid", "@laboratoryid", "@itemcode", "@admissionid", "@patientrequestno", "@specimen", "@labno", "@datesubmitted", "@dateencoded", _
                                  "@encodedby", "@pathologist", "@medicaltechnologist", "@medtech", "@releasedby", "@datereleased"}
        Dim strVal() As Object = {operation, soperation, Me.Oldlaboratoryid, Me.laboratoryid, Me.itemcatcode, Me.admissionid, Me.patientrequestno, Me.specimen, Me.labno, Me.datesubmitted, Me.dateencoded, _
                                    Me.encodedby, Me.pathologist, Me.medicaltechnologist, Me.medtech, Me.releasedby, Me.datereleased}
